...
const Elds = () => {
  ...
  return (
    <div>
      <Navbar />
    <div className='elds-container'>
      <Sidebar />
      <div className='elds-content'>
        <div className='elds-contain'>
        <h1 className='merit-h1'>Admission Criteria /<a href='!#' className='merit-a'>Educationally Less Developed States(ELDs)</a> </h1>
            <div className='user1'>
                ...
                <Table variant='simple' size="sm" >
                  <Thead>
                    <Tr>
                      ...
                      <Th>Faculty</Th>
                      <Th>Program</Th>
                      <Th colSpan={5} style={rightAlignedHeaderStyle}>Educationally Less Developed States(ELDs) <br/>
                      <Tr >
                      <Th style={subHeaderStyle}>Kwara</Th>
                      <Th style={subHeaderStyle}>Kogi</Th>
                      <Th style={subHeaderStyle}>Kaduna</Th>
                      <Th style={subHeaderStyle}>Kano</Th>
                      <Th style={subHeaderStyle}>Kastina</Th> 
