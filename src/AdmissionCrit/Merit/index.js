  ...
  return (
    ...
    <div className='merit-container'>
      ...
      <div className='merit-content'>
        <div className='merit-contain'>
       <h1 className='merit-h1'>Admission Criteria /<a href='!#' className='merit-a'>Merit</a> </h1>
          <div className='user1'>    
                            <div className='user2'>                          
